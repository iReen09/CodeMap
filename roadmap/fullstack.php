...
<body class="bg-gray-900 text-white min-h-screen">
    ...
    <main class="max-w-6xl mx-auto px-4 py-8">
        <!-- Header Section -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold mb-2">Fullstack Developer Roadmap</h1>
            <p class="text-gray-400">Panduan langkah demi langkah untuk menjadi backend developer pada 2024.</p>
        </div>
